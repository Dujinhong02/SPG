...
#         # return_meta but no return_width_orig
#         if return_keep2:
#             return (final_grasps, final_ids.tolist(), stage_tag,
#                     keep3_grasps, keep3_ids.tolist(),
#                     keep2_grasps, keep2_ids.tolist())
...
if __name__ == "__main__":
    ...
    ply_p = '/root/catkin_ws/src/more_than_grasp/refine/data/obj_ply/cloud_object3.ply'
    ...
    t1 = time.time()
    grasp_pose, _ = pmatch_for_draw(ply_p)
