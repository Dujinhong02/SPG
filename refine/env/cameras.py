...
class RealSenseD435:
    ...
    # left_position = (0.0, 0.5, 0.75)
    # left_rotation = (np.pi / 4.5, np.pi, np.pi / 4)
    # left_position = (0.5, 0.5, 0.75)
    left_position = (0.25, 0.5, 0.65)
    left_rotation = (np.pi / 4, np.pi, np.pi / 6)
    left_rotation = p.getQuaternionFromEuler(left_rotation)
    # right_position = (0.0, -0.5, 0.75)
    # right_rotation = (np.pi / 4.5, np.pi, 3 * np.pi / 4)
    # right_position = (0.5, -0.5, 0.75)
    right_position = (0.85, -0.5, 0.65)
    right_rotation = (np.pi / 4, np.pi, 5 * np.pi / 4)
